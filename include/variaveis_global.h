...
unsigned long intervalo_tempo_aceleracao = 200000; // 100 ms em microssegundos Intervalo de tempo para calcular a taxa de mudança do TPS 
...
unsigned long duracao_enriquecimento = 500000; // Tempo em microssegundos para manter o valor após a última mudança
...
float enriquecimento_aceleracao = 10; // Quantidade de enriquecimento de combustível em porcentagem
float enriquecimento_desaceleracao = 0; // Quantidade de redução de combustível em porcentagem
int valor_o2 = 0;
int sonda_narrow = 0;